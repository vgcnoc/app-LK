    ...
    <AuthenticatedLayout>
        ...
        <div class="mb-8 bg-gradient-to-r from-indigo-600 to-indigo-800 rounded-3xl p-8 text-white shadow-lg relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div class="bg-indigo-900 bg-opacity-50 border border-indigo-500 border-opacity-30 p-6 rounded-2xl text-center min-w-[220px] shadow-inner">
                    <div class="text-indigo-200 text-sm font-medium mb-1 uppercase tracking-wider">Total Estimasi Komisi</div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow relative overflow-hidden group">
                ...
                <div class="relative z-10">
                    ...
                    <h4 class="text-slate-500 text-sm font-medium mb-1">Anggota Jaringan</h4>
                    <div class="text-3xl font-bold text-slate-800">{{ metrics.totalDownlines }} <span class="text-sm font-normal text-slate-400 ml-1">orang</span></div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow relative overflow-hidden group">
                ...
                <div class="relative z-10">
                    ...
                    <h4 class="text-slate-500 text-sm font-medium mb-1">Total Prospek</h4>
                    <div class="text-3xl font-bold text-slate-800">{{ metrics.totalBooking }} <span class="text-sm font-normal text-slate-400 ml-1">calon</span></div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow relative overflow-hidden group">
                ...
                <div class="relative z-10">
                    ...
                    <h4 class="text-slate-500 text-sm font-medium mb-1">Pelanggan Aktif</h4>
                    <div class="text-3xl font-bold text-slate-800">{{ metrics.activeBooking }} <span class="text-sm font-normal text-slate-400 ml-1">pelanggan</span></div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow relative overflow-hidden group">
                ...
                <div class="relative z-10">
                    ...
                    <h4 class="text-slate-500 text-sm font-medium mb-1">Menunggu Persetujuan</h4>
                    <div class="text-3xl font-bold text-slate-800">{{ metrics.pendingBooking }} <span class="text-sm font-normal text-slate-400 ml-1">calon</span></div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-white rounded-3xl p-6 shadow-sm border border-slate-100">
                ...
                <Link :href="route('affiliates.index')" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-xl text-white bg-indigo-600 hover:bg-indigo-700 transition-colors w-full md:w-auto">
                    Lihat Jaringan Saya
                </Link>
            </div>
            ...
            <div class="bg-white rounded-3xl p-6 shadow-sm border border-slate-100">
                ...
                <Link :href="route('booking.index')" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-xl text-white bg-emerald-600 hover:bg-emerald-700 transition-colors w-full md:w-auto">
                    Buat Booking Baru
                </Link>
            </div>
        </div>
