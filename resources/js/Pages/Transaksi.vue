...
const filteredTransactions = computed(() => {
    ...
    // Sort by date (desc) and then created_at (desc)
    result.sort((a, b) => {
        const dateA = a.date ? String(a.date).substring(0, 10) : '';
        const dateB = b.date ? String(b.date).substring(0, 10) : '';
        if (dateA !== dateB) {
...
<!-- Removed Summary Cards -->
                ...
                <div class="space-y-4">
                    <!-- Banner Ringkasan Area -->
                    <div class="relative overflow-hidden bg-gradient-to-r from-[#eff2fe] via-[#e4e8fd] to-[#f4f2ff] rounded-2xl p-6 md:p-7 flex flex-col lg:flex-row items-center justify-between shadow-sm border border-indigo-50/50 mb-2">
                        <!-- Decorative SVG right -->
                        <div class="absolute right-0 bottom-0 pointer-events-none opacity-40">
                            <svg width="200" height="120" viewBox="0 0 200 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M100 120C100 53.7258 153.726 0 220 0H250V120H100Z" fill="#a5b4fc" />
                                <circle cx="180" cy="50" r="20" fill="#818cf8" />
                                <rect x="130" y="70" width="40" height="40" rx="8" fill="#6366f1" />
                            </svg>
                        </div>
                        
                        <!-- Left text -->
                        <div class="relative z-10 flex items-center gap-4 mb-6 lg:mb-0 w-full lg:w-auto">
                            <div class="p-4 bg-white/90 text-[#5e4ee5] rounded-2xl shadow-sm shrink-0">
                                <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z" />
                                </svg>
                            </div>
                            <div>
                                <h3 class="text-2xl font-bold text-slate-800 tracking-tight">Ringkasan Area</h3>
                                <p class="text-sm text-slate-500 mt-1">Distribusi keuangan berdasarkan wilayah operasional</p>
                            </div>
                        </div>

                        <!-- Right buttons -->
                        <div class="relative z-10 flex flex-col sm:flex-row items-center gap-3 w-full lg:w-auto">
                            <div class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-white border border-slate-200 rounded-xl text-sm font-semibold text-slate-600 shadow-sm">
                            ...
                            <button
                                @click="openModal"
                                type="button"
                                class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-[#5e4ee5] hover:bg-[#4b3cc7] text-white text-sm font-semibold rounded-xl shadow-md transition-all duration-200"
                            >
                    ...
                    <div v-if="areaSummaries && areaSummaries.length > 0" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        <div
                        ...
                        >
                            ...
                            <div class="absolute bottom-0 left-0 right-0 h-20 opacity-15 pointer-events-none">
                            ...
                            <div class="flex items-start justify-between mb-6 relative z-10">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <span class="text-[11px] text-slate-400">Area Operasional</span>
                                    </div>
                                </div>
                                <div :class="[
                                    'px-2 py-1 rounded-md text-[10px] font-bold tracking-wide shrink-0',
                                    index % 4 === 0 ? 'bg-emerald-50 text-emerald-600' : 
                            ...
                            <div class="space-y-2.5 text-[13px] mb-6 relative z-10 flex-grow">
                            ...
                            <div class="mt-auto relative z-10">
                                <div :class="[
                                    ...
                                    index % 4 === 0 ? 'bg-emerald-50/80 text-emerald-700' : 
                                    index % 4 === 1 ? 'bg-blue-50/80 text-blue-700' : 
                                    index % 4 === 2 ? 'bg-purple-50/80 text-purple-700' : 
                            ...
                            <div class="flex flex-wrap sm:flex-nowrap gap-2">
                                ...
                                <div class="relative">
                                    <select
                                        ...
                                        class="pl-3 pr-8 py-2 w-full md:w-auto bg-slate-50 border border-slate-200 focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 rounded-xl text-xs sm:text-sm font-medium text-slate-700 appearance-none transition-all duration-200 cursor-pointer"
                                    >
                                    ...
                                    <td class="px-3 py-3 sm:px-6 sm:py-4 whitespace-nowrap text-center">
                                        <div class="flex items-center justify-center gap-2">
                                            <button
                                                type="button"
                                                title="Lihat Detail"
                                                class="p-1.5 text-indigo-500 hover:text-white hover:bg-indigo-500 bg-indigo-50 rounded-lg transition-colors border border-indigo-100"
                                            >
